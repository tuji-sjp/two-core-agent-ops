...
const NODE_LABELS = ['开始', '采集', '立案', '扣费', '理算', '审核', '结束']
...
const NODE_CALL_RECORDS: Record<string, Record<string, CallRecord[]>> = {
  'A1000000000': {
    ...
    '扣费': [{ time: '2026-06-02 10:23', success: true }, { time: '2026-06-02 10:25', success: true }],
  ...
  'B1000000001': {
    ...
    '扣费': [{ time: '2026-06-01 09:15', success: false }, { time: '2026-06-01 09:16', success: true }, { time: '2026-06-01 09:17', success: false }, { time: '2026-06-01 09:18', success: false }],
  ...
  'C1000000002': {
    ...
    '扣费': [{ time: '2026-05-30 14:10', success: true }],
  ...
  'D1000000003': {
    ...
    '扣费': [{ time: '2026-05-27 11:00', success: true }, { time: '2026-05-27 11:01', success: false }],
  ...
  'E1000000004': {
    ...
    '扣费': [{ time: '2026-05-24 08:30', success: true }, { time: '2026-05-24 08:31', success: true }, { time: '2026-05-24 08:32', success: false }],
  ...
  'F1000000005': {
    ...
    '扣费': [{ time: '2026-05-22 16:00', success: true }],
  ...
  'G1000000006': {
    ...
    '扣费': [{ time: '2026-05-20 13:00', success: true }, { time: '2026-05-20 13:01', success: false }],
  ...
  'H1000000007': {
    ...
    '扣费': [{ time: '2026-05-17 10:00', success: true }],
  ...
  'I1000000008': {
    ...
    '扣费': [{ time: '2026-05-16 09:00', success: true }, { time: '2026-05-16 09:01', success: false }],
  ...
  'J1000000009': {
    ...
    '扣费': [{ time: '2026-05-14 14:30', success: true }, { time: '2026-05-14 14:31', success: true }],
  ...
  'O1000000014': {
    ...
    '扣费': [{ time: '2026-05-06 10:00', success: true }, { time: '2026-05-06 10:01', success: true }],
...
const FlowTrajectoryGraph: React.FC<{ trajectory: FlowTrajectory; caseNo?: string }> = ({ trajectory, caseNo }) => {
  ...
  const NODE_ROUTE_MAP: Record<string, string> = {
    ...
    '扣费': '/agent/claims/deduction-log-detail',
  }
  ...
  // 扣费日志 lookup（用于通过 caseNo + 调用时间匹配 taskId）
  const DEDUCTION_LOGS = [
    { caseNo: 'A1000000000', taskId: '2044719741488838912', callTime: '2026-06-02 10:23' },
    { caseNo: 'A1000000000', taskId: '2044719741388838912', callTime: '2026-06-02 10:25' },
    { caseNo: 'B1000000001', taskId: '2044719741288838912', callTime: '2026-06-01 09:15' },
    { caseNo: 'B1000000001', taskId: '2044719741188838912', callTime: '2026-06-01 09:16' },
    { caseNo: 'B1000000001', taskId: '2044719741088838912', callTime: '2026-06-01 09:17' },
    { caseNo: 'B1000000001', taskId: '2044719740988838912', callTime: '2026-06-01 09:18' },
    { caseNo: 'C1000000002', taskId: '2044719740888838912', callTime: '2026-05-30 14:10' },
    { caseNo: 'D1000000003', taskId: '2044719740788838912', callTime: '2026-05-27 11:00' },
    { caseNo: 'D1000000003', taskId: '2044719740688838912', callTime: '2026-05-27 11:01' },
    { caseNo: 'E1000000004', taskId: '2044719740588838912', callTime: '2026-05-24 08:30' },
    { caseNo: 'E1000000004', taskId: '2044719740488838912', callTime: '2026-05-24 08:31' },
    { caseNo: 'E1000000004', taskId: '2044719740388838912', callTime: '2026-05-24 08:32' },
    { caseNo: 'F1000000005', taskId: '2044719740288838912', callTime: '2026-05-22 16:00' },
    { caseNo: 'G1000000006', taskId: '2044719740188838912', callTime: '2026-05-20 13:00' },
    { caseNo: 'G1000000006', taskId: '2044719740088838912', callTime: '2026-05-20 13:01' },
    { caseNo: 'H1000000007', taskId: '2044719739988838912', callTime: '2026-05-17 10:00' },
    { caseNo: 'I1000000008', taskId: '2044719739888838912', callTime: '2026-05-16 09:00' },
    { caseNo: 'I1000000008', taskId: '2044719739788838912', callTime: '2026-05-16 09:01' },
    { caseNo: 'J1000000009', taskId: '2044719739688838912', callTime: '2026-05-14 14:30' },
    { caseNo: 'J1000000009', taskId: '2044719739588838912', callTime: '2026-05-14 14:31' },
  ]
  ...
  const handleViewDetail = (nodeName: string, callTime: string) => {
    ...
    if (route && caseNo) {
      let taskId = ''
      if (nodeName === '扣费') {
        const matchedLog = DEDUCTION_LOGS.find(
          log => log.caseNo === caseNo && callTime.startsWith(log.callTime)
        )
        taskId = matchedLog ? matchedLog.taskId : ''
      } else {
...
const MOCK_CASES: CaseRecord[] = [
  { key: '1', caseNo: 'R2012144777', claimNo: '0012435281', branch: '山西', accidentDate: '2026-08-15', claimDate: '2026-08-19', currentNode: '采集智能体', status: 'processing' },
  { key: '2', caseNo: 'J3012144807', claimNo: '0012435311', branch: '安徽', accidentDate: '2026-08-12', claimDate: '2026-08-19', currentNode: '立案智能体', status: 'completed' },
  { key: '3', caseNo: '61012144789', claimNo: '0012435291', branch: '辽宁', accidentDate: '2026-08-05', claimDate: '2026-08-19', currentNode: '理算智能体', status: 'processing' },
  { key: '4', caseNo: 'P4012144799', claimNo: '0012435306', branch: '云南', accidentDate: '2026-08-01', claimDate: '2026-08-19', currentNode: '扣费智能体', status: 'processing' },
  { key: '5', caseNo: 'F1012140749', claimNo: '0012431428', branch: '重庆', accidentDate: '2026-08-16', claimDate: '2026-08-18', currentNode: '立案智能体', status: 'completed' },
  { key: '6', caseNo: '3F012142595', claimNo: '0012433215', branch: '广东', accidentDate: '2026-08-14', claimDate: '2026-08-18', currentNode: '审核智能体', status: 'completed' },
  { key: '7', caseNo: '5E012142247', claimNo: '0012432864', branch: '四川', accidentDate: '2026-08-10', claimDate: '2026-08-18', currentNode: '理算智能体', status: 'processing' },
  { key: '8', caseNo: '41012142606', claimNo: '0012433225', branch: '上海', accidentDate: '2026-08-08', claimDate: '2026-08-18', currentNode: '审核智能体', status: 'processing' },
  { key: '9', caseNo: 'N1012142270', claimNo: '0012432909', branch: '河北', accidentDate: '2026-08-07', claimDate: '2026-08-18', currentNode: '采集智能体', status: 'processing' },
  { key: '10', caseNo: 'F1012142607', claimNo: '0012433226', branch: '重庆', accidentDate: '2026-08-03', claimDate: '2026-08-18', currentNode: '扣费智能体', status: 'completed' },
  { key: '10b', caseNo: 'K1000000010', claimNo: '0000000010', branch: 'LIC', accidentDate: '2026-05-11', claimDate: '2026-05-13', currentNode: '立案智能体', status: 'completed' },
  { key: '11', caseNo: 'L1000000011', claimNo: '0000000011', branch: 'LIC', accidentDate: '2026-05-10', claimDate: '2026-05-12', currentNode: '采集智能体', status: 'processing' },
  { key: '12', caseNo: 'M1000000012', claimNo: '0000000012', branch: 'LIC', accidentDate: '2026-05-08', claimDate: '2026-05-10', currentNode: '立案智能体', status: 'completed' },
  { key: '13', caseNo: 'N1000000013', claimNo: '0000000013', branch: 'LIC', accidentDate: '2026-05-06', claimDate: '2026-05-08', currentNode: '理算智能体', status: 'processing' },
  { key: '14', caseNo: 'O1000000014', claimNo: '0000000014', branch: 'LIC', accidentDate: '2026-05-04', claimDate: '2026-05-06', currentNode: '扣费智能体', status: 'processing' },
  { key: '15', caseNo: 'P1000000015', claimNo: '0000000015', branch: 'LIC', accidentDate: '2026-05-02', claimDate: '2026-05-04', currentNode: '审核智能体', status: 'completed' },
  { key: '16', caseNo: 'Q1000000016', claimNo: '0000000016', branch: 'LIC', accidentDate: '2026-04-30', claimDate: '2026-05-02', currentNode: '采集智能体', status: 'processing' },
  { key: '17', caseNo: 'R1000000017', claimNo: '0000000017', branch: 'LIC', accidentDate: '2026-04-28', claimDate: '2026-04-30', currentNode: '立案智能体', status: 'completed' },
  { key: '18', caseNo: 'S1000000018', claimNo: '0000000018', branch: 'LIC', accidentDate: '2026-04-26', claimDate: '2026-04-28', currentNode: '理算智能体', status: 'processing' },
  { key: '19', caseNo: 'T1000000019', claimNo: '0000000019', branch: 'LIC', accidentDate: '2026-04-24', claimDate: '2026-04-26', currentNode: '扣费智能体', status: 'processing' },
  { key: '20', caseNo: 'U1000000020', claimNo: '0000000020', branch: 'LIC', accidentDate: '2026-04-22', claimDate: '2026-04-24', currentNode: '审核智能体', status: 'completed' },
]
