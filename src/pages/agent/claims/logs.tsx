...
const MOCK_COLLECTION_LOGS: CollectionLogRecord[] = [
  ...
  { key: '2', taskId: '2044719745288838912', requestId: 'a002', caseNo: 'A1000000000', claimNo: '0000000001', status: 'processing', createdAt: '2026-06-02 10:25', platformTime: '-', engineTime: '-', queryDataTime: '-', isMedicalRecord: true, engineMsg: '处理中', imageCount: 0 },
  { key: '3', taskId: '2044719745188838913', requestId: 'a003', caseNo: 'A1000000000', claimNo: '0000000001', status: 'success', createdAt: '2026-06-02 10:25', platformTime: '32s 174ms', engineTime: '31s 865ms', queryDataTime: '602ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 34 },
  { key: '4', taskId: '2044719745188838912', requestId: 'b003', caseNo: 'B1000000001', claimNo: '0000000002', status: 'failed', createdAt: '2026-06-01 09:15', platformTime: '39s 211ms', engineTime: '38s 11ms', queryDataTime: '1s 626ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 45 },
  { key: '5', taskId: '2044719745088838912', requestId: 'b004', caseNo: 'B1000000001', claimNo: '0000000002', status: 'success', createdAt: '2026-06-01 09:16', platformTime: '46s 248ms', engineTime: '45s 48ms', queryDataTime: '1s 503ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 56 },
  { key: '6', taskId: '2044719744988838912', requestId: 'b005', caseNo: 'B1000000001', claimNo: '0000000002', status: 'success', createdAt: '2026-06-01 09:17', platformTime: '53s 285ms', engineTime: '52s 85ms', queryDataTime: '1s 414ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 67 },
  { key: '7', taskId: '2044719744888838912', requestId: 'b006', caseNo: 'B1000000001', claimNo: '0000000002', status: 'failed', createdAt: '2026-06-01 09:18', platformTime: '1m 0s 322ms', engineTime: '59s 122ms', queryDataTime: '1s 071ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 78 },
  { key: '8', taskId: '2044719744788838912', requestId: 'c007', caseNo: 'C1000000002', claimNo: '0000000003', status: 'success', createdAt: '2026-05-30 14:10', platformTime: '1m 7s 359ms', engineTime: '1m 6s 159ms', queryDataTime: '919ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 89 },
  { key: '9', taskId: '2044719744688838912', requestId: 'd008', caseNo: 'D1000000003', claimNo: '0000000004', status: 'processing', createdAt: '2026-05-27 11:00', platformTime: '-', engineTime: '-', queryDataTime: '-', isMedicalRecord: true, engineMsg: '处理中', imageCount: 0 },
  { key: '10', taskId: '2044719744588838912', requestId: 'd009', caseNo: 'D1000000003', claimNo: '0000000004', status: 'failed', createdAt: '2026-05-27 11:01', platformTime: '1m 21s 433ms', engineTime: '1m 20s 233ms', queryDataTime: '856ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 31 },
  { key: '11', taskId: '2044719744488838912', requestId: 'e010', caseNo: 'E1000000004', claimNo: '0000000005', status: 'success', createdAt: '2026-05-24 08:30', platformTime: '1m 28s 470ms', engineTime: '1m 27s 270ms', queryDataTime: '2s 918ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 42 },
  { key: '12', taskId: '2044719744388838912', requestId: 'e011', caseNo: 'E1000000004', claimNo: '0000000005', status: 'success', createdAt: '2026-05-24 08:31', platformTime: '1m 35s 507ms', engineTime: '1m 34s 307ms', queryDataTime: '2s 228ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 53 },
  { key: '13', taskId: '2044719744288838912', requestId: 'e012', caseNo: 'E1000000004', claimNo: '0000000005', status: 'failed', createdAt: '2026-05-24 08:32', platformTime: '22s 544ms', engineTime: '21s 344ms', queryDataTime: '630ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 64 },
  { key: '14', taskId: '2044719744188838912', requestId: 'f013', caseNo: 'F1000000005', claimNo: '0000000006', status: 'success', createdAt: '2026-05-22 16:00', platformTime: '29s 581ms', engineTime: '28s 381ms', queryDataTime: '622ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 75 },
  { key: '15', taskId: '2044719744088838912', requestId: 'g014', caseNo: 'G1000000006', claimNo: '0000000007', status: 'success', createdAt: '2026-05-20 13:00', platformTime: '36s 618ms', engineTime: '35s 418ms', queryDataTime: '883ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 86 },
  { key: '16', taskId: '2044719743988838912', requestId: 'g015', caseNo: 'G1000000006', claimNo: '0000000007', status: 'failed', createdAt: '2026-05-20 13:01', platformTime: '43s 655ms', engineTime: '42s 455ms', queryDataTime: '1s 395ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 17 },
  { key: '17', taskId: '2044719743888838912', requestId: 'h016', caseNo: 'H1000000007', claimNo: '0000000008', status: 'success', createdAt: '2026-05-17 10:00', platformTime: '50s 692ms', engineTime: '49s 492ms', queryDataTime: '1s 452ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 28 },
  { key: '18', taskId: '2044719743788838912', requestId: 'i017', caseNo: 'I1000000008', claimNo: '0000000009', status: 'success', createdAt: '2026-05-16 09:00', platformTime: '57s 729ms', engineTime: '56s 529ms', queryDataTime: '2s 569ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 39 },
  { key: '19', taskId: '2044719743688838912', requestId: 'i018', caseNo: 'I1000000008', claimNo: '0000000009', status: 'processing', createdAt: '2026-05-16 09:01', platformTime: '-', engineTime: '-', queryDataTime: '-', isMedicalRecord: false, engineMsg: '处理中', imageCount: 0 },
  { key: '20', taskId: '2044719743588838912', requestId: 'j019', caseNo: 'J1000000009', claimNo: '0000000010', status: 'success', createdAt: '2026-05-14 14:30', platformTime: '1m 11s 803ms', engineTime: '1m 10s 603ms', queryDataTime: '608ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 61 },
  { key: '21', taskId: '2044719743488838912', requestId: 'j020', caseNo: 'J1000000009', claimNo: '0000000010', status: 'success', createdAt: '2026-05-14 14:31', platformTime: '1m 18s 840ms', engineTime: '1m 17s 640ms', queryDataTime: '2s 798ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 72 },
  { key: '22', taskId: '2044719743388838912', requestId: 'j021', caseNo: 'J1000000009', claimNo: '0000000010', status: 'failed', createdAt: '2026-05-14 14:32', platformTime: '1m 25s 877ms', engineTime: '1m 24s 677ms', queryDataTime: '1s 314ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 83 },
  { key: '23', taskId: '2044719743288838912', requestId: 'k022', caseNo: 'K1000000010', claimNo: '0000000010', status: 'success', createdAt: '2026-05-13 10:00', platformTime: '1m 32s 914ms', engineTime: '1m 31s 714ms', queryDataTime: '2s 732ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 14 },
  { key: '24', taskId: '2044719743188838912', requestId: 'k023', caseNo: 'K1000000010', claimNo: '0000000010', status: 'success', createdAt: '2026-05-13 10:02', platformTime: '19s 951ms', engineTime: '18s 751ms', queryDataTime: '2s 218ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 25 },
  { key: '25', taskId: '2044719743088838912', requestId: 'l024', caseNo: 'L1000000011', claimNo: '0000000011', status: 'failed', createdAt: '2026-05-12 11:00', platformTime: '26s 988ms', engineTime: '25s 788ms', queryDataTime: '1s 402ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 36 },
  { key: '26', taskId: '2044719742988838912', requestId: 'm025', caseNo: 'M1000000012', claimNo: '0000000012', status: 'success', createdAt: '2026-05-10 15:00', platformTime: '33s 126ms', engineTime: '32s 474ms', queryDataTime: '2s 339ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 47 },
  { key: '27', taskId: '2044719742888838912', requestId: 'm026', caseNo: 'M1000000012', claimNo: '0000000012', status: 'success', createdAt: '2026-05-10 15:01', platformTime: '40s 163ms', engineTime: '39s 457ms', queryDataTime: '2s 913ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 58 },
  { key: '28', taskId: '2044719742788838912', requestId: 'n027', caseNo: 'N1000000013', claimNo: '0000000013', status: 'failed', createdAt: '2026-05-08 09:30', platformTime: '47s 200ms', engineTime: '46s 440ms', queryDataTime: '1s 639ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 69 },
  { key: '29', taskId: '2044719742688838912', requestId: 'o028', caseNo: 'O1000000014', claimNo: '0000000014', status: 'processing', createdAt: '2026-05-06 10:00', platformTime: '-', engineTime: '-', queryDataTime: '-', isMedicalRecord: true, engineMsg: '处理中', imageCount: 0 },
  { key: '30', taskId: '2044719742588838912', requestId: 'o029', caseNo: 'O1000000014', claimNo: '0000000014', status: 'success', createdAt: '2026-05-06 10:01', platformTime: '1m 1s 274ms', engineTime: '1m 0s 74ms', queryDataTime: '1s 153ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 91 },
  { key: '31', taskId: '2044719742488838912', requestId: 'p030', caseNo: 'P1000000015', claimNo: '0000000015', status: 'failed', createdAt: '2026-05-04 08:00', platformTime: '1m 8s 311ms', engineTime: '1m 7s 111ms', queryDataTime: '2s 231ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 22 },
  { key: '32', taskId: '2044719742388838912', requestId: 'q031', caseNo: 'Q1000000016', claimNo: '0000000016', status: 'success', createdAt: '2026-05-02 12:00', platformTime: '1m 15s 348ms', engineTime: '1m 14s 148ms', queryDataTime: '1s 893ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 33 },
  { key: '33', taskId: '2044719742288838912', requestId: 'q032', caseNo: 'Q1000000016', claimNo: '0000000016', status: 'success', createdAt: '2026-05-02 12:01', platformTime: '1m 22s 385ms', engineTime: '1m 21s 185ms', queryDataTime: '1s 638ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 44 },
  { key: '34', taskId: '2044719742188838912', requestId: 'q033', caseNo: 'Q1000000016', claimNo: '0000000016', status: 'failed', createdAt: '2026-05-02 12:02', platformTime: '1m 29s 422ms', engineTime: '1m 28s 222ms', queryDataTime: '1s 136ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 55 },
  { key: '35', taskId: '2044719742088838912', requestId: 'r034', caseNo: 'R1000000017', claimNo: '0000000017', status: 'processing', createdAt: '2026-04-30 16:30', platformTime: '-', engineTime: '-', queryDataTime: '-', isMedicalRecord: true, engineMsg: '处理中', imageCount: 0 },
  { key: '36', taskId: '2044719741988838912', requestId: 's035', caseNo: 'S1000000018', claimNo: '0000000018', status: 'success', createdAt: '2026-04-28 14:00', platformTime: '23s 496ms', engineTime: '22s 296ms', queryDataTime: '1s 878ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 77 },
  { key: '37', taskId: '2044719741888838912', requestId: 's036', caseNo: 'S1000000018', claimNo: '0000000018', status: 'failed', createdAt: '2026-04-28 14:01', platformTime: '30s 533ms', engineTime: '29s 333ms', queryDataTime: '918ms', isMedicalRecord: false, engineMsg: '引擎超时', imageCount: 88 },
  { key: '38', taskId: '2044719741788838912', requestId: 't037', caseNo: 'T1000000019', claimNo: '0000000019', status: 'success', createdAt: '2026-04-26 09:00', platformTime: '37s 570ms', engineTime: '36s 370ms', queryDataTime: '879ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 19 },
  { key: '39', taskId: '2044719741688838912', requestId: 'u038', caseNo: 'U1000000020', claimNo: '0000000020', status: 'success', createdAt: '2026-04-24 11:30', platformTime: '44s 607ms', engineTime: '43s 407ms', queryDataTime: '2s 056ms', isMedicalRecord: true, engineMsg: '处理成功', imageCount: 30 },
  { key: '40', taskId: '2044719741588838912', requestId: 'u039', caseNo: 'U1000000020', claimNo: '0000000020', status: 'failed', createdAt: '2026-04-24 11:31', platformTime: '51s 644ms', engineTime: '50s 444ms', queryDataTime: '896ms', isMedicalRecord: true, engineMsg: '引擎超时', imageCount: 41 },
]
